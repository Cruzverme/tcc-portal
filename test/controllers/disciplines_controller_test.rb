...
class DisciplinesControllerTest < ActionController::TestCase
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post :create, discipline: { bibliography: @discipline.bibliography, curso_id: @discipline.curso_id, description: @discipline.description, ementa: @discipline.ementa, name: @discipline.name, workload: @discipline.workload }
    end
  ...
  test "should update discipline" do
    patch :update, id: @discipline, discipline: { bibliography: @discipline.bibliography, curso_id: @discipline.curso_id, description: @discipline.description, ementa: @discipline.ementa, name: @discipline.name, workload: @discipline.workload }
    assert_redirected_to discipline_path(assigns(:discipline))
  end
