...
ActiveRecord::Schema.define(version: 20160726234558) do
  ...
  add_index "cameras", ["curso_id"], name: "index_cameras_on_curso_id", using: :btree
  ...
  add_foreign_key "cameras", "cursos"
